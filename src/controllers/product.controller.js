...
class ProductController {
  static getAllProduct = async (req, res, next) => {
    ...
    const { products, options } = await ProductService.getAllProducts({
      ...query,
      filter,
    });
    new OK({
  ...
  static getProductInfo = async (req, res, next) => {
    new OK({
      ...
      metadata: await ProductService.getProductInfo({
  ...
  static searchProductsByEmployee = async (req, res, next) => {
    ...
    new OK({
      ...
      metadata: await ProductService.searchProductsByEmployee({
